...
var slider = function slider() {
  ...
  function initSlider() {
    if (document.documentElement.clientWidth < 1184) {
      var dotsActive = function dotsActive(countSelector, classSelector, arrSelector) {
        arrSelector[countSelector].classList.add(classSelector);
      };
      var dotsNotActive = function dotsNotActive(classSelector, arrSelector) {
        arrSelector.forEach(function (element) {
      ...
      var nextItem = function nextItem() {
        if (i < (width + 20) * (sliderLength.length - 1)) {
          i += width + 20;
          counter++;
          slide.style.transform = "translateX(-".concat(i, "px)");
          btnActive();
          dot++;
      ...
      var dots = function dots() {
        for (var _i = 0; _i <= sliderLength.length; _i++) {
      ...
      var sliderLength = document.querySelectorAll(".slide_item");
      var slide = document.querySelector(".stages__cards_wrap");
      var width = sliderLength[0].clientWidth;
      var dotsWrap = document.querySelector(".stages__btn-dots");
      var prev = document.querySelector(".stages__btn-prev");
      var next = document.querySelector(".stages__btn-next");
      var dotsArr;
      var counter = 0;
      var i = 0;
      var dot = 0;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   sliderpart: () => (/* binding */ sliderpart)
/* harmony export */ });
...
var sliderpart = function sliderpart() {
  var slide = document.querySelector(".participants__slider");
  var slidlength = document.querySelectorAll(".slider__item");
  var slidWidth = slidlength[0].clientWidth;
  var slidPrev = document.querySelector(".participants__btn-prev");
  var slidNext = document.querySelector(".participants__btn-next");
  ...
  var s = /*#__PURE__*/function () {
    function s(slidSelector, /* widthSelector, */
    prevSelector, nextSelector, numberSelector, totalSelector, slidLengthSelector, timerSelector) {
    ...
    return _createClass(s, [{
      key: "resiz",
      value: function resiz() {
        var _this = this;
        window.addEventListener("resize", function () {
          _this.w = _this.slLength[0].clientWidth;
          m = 0;
          n = 0;
          _this.slid.style.transform = "translateX(-".concat(n, "px)");
        });
      }
    }, {
      key: "btn",
      ...
      value: function sliderNext() {
        ...
        this.next.addEventListener("click", function () {
          if (n !== _this2.w * (_this2.slLength.length - 1)) {
            n += _this2.w;
            _this2.slid.style.transform = "translateX(-".concat(n, "px)");
            m++;
            _this2.btn();
            _this2.numb.innerText = m + 1 + "/";
          } else if (n === _this2.w * (_this2.slLength.length - 1)) {
            n = 0;
            m = 0;
            _this2.slid.style.transform = "translateX(-".concat(n, "px)");
            _this2.btn();
      ...
      value: function sliderPrev() {
        ...
        this.prev.addEventListener("click", function () {
          if (n != 0) {
            n -= _this3.w;
            _this3.slid.style.transform = "translateX(-".concat(n, "px)");
            m--;
            _this3.btn();
            _this3.numb.innerText = m + 1 + "/";
          } else if (n === 0) {
            n = _this3.w * (_this3.slLength.length - 1);
            m = _this3.slLength.length - 1;
            _this3.slid.style.transform = "translateX(-".concat(n, "px)");
            _this3.btn();
            _this3.numb.innerText = m + 1 + "/";
          }
      ...
      key: "totalInit",
      value: function totalInit() {
        this.total.innerText = this.slLength.length;
      }
    }, {
      key: "timout",
      value: function timout() {
        var _this4 = this;
        if (this.time === true) {
          setInterval(function () {
            return _this4.next.dispatchEvent(event);
          }, 4000);
        }
      }
    }]);
...
/* harmony import */ var _modules_sliderpart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliderpart */ "./src/js/modules/sliderpart.js");


window.addEventListener("DOMContentLoaded", function () {
  (0,_modules_slider__WEBPACK_IMPORTED_MODULE_0__.slider)();
  (0,_modules_sliderpart__WEBPACK_IMPORTED_MODULE_1__.sliderpart)();
});
/******/ })()
;
